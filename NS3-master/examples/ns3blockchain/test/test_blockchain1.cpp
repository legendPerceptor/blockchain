//
// Created by Hython on 2020/2/26.
//
...
#include "model/blockchainnode.h"
...
using namespace ns3;
using namespace ns3::blockchain;
...
int main(int argc, char *argv[])
{
    ...
    Cryptocurrency cryptocurrency = Cryptocurrency::HYPERLEDGER;
    ...
    double *minersHash;
    BlockchainRegion *minersRegions;
    int noMiners =1;
    int noEndorsers = 6;
    int noClient = 10;
        ...
        double blockchainMinerHash[] = {0.289, 0.196, 0.159, 0.133, 0.066, 0.054, 0.029,
                                        ...
                                        0.002, 0.002};
        BlockchainRegion blockchainMinersRegions[] = {BlockchainRegion::KOREA, BlockchainRegion::KOREA, BlockchainRegion::KOREA, BlockchainRegion::NORTH_AMERICA,
                                                      BlockchainRegion::KOREA, BlockchainRegion::NORTH_AMERICA, BlockchainRegion::EUROPE, BlockchainRegion::EUROPE,
                                                      BlockchainRegion::NORTH_AMERICA, BlockchainRegion::NORTH_AMERICA, BlockchainRegion::NORTH_AMERICA, BlockchainRegion::EUROPE,
                                                      BlockchainRegion::NORTH_AMERICA, BlockchainRegion::NORTH_AMERICA, BlockchainRegion::NORTH_AMERICA, BlockchainRegion::NORTH_AMERICA};

    #else

        double blockchainMinerHash[] = {0.5, 0.5};
        BlockchainRegion blockchainMinersRegions[] = {BlockchainRegion::KOREA, BlockchainRegion::KOREA};
