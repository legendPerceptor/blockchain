...
add_definitions(-DPROJECT_SOURCE_PATH="${PROJECT_SOURCE_DIR_NS3}")
...
#Output folders
set(CMAKE_OUTPUT_DIRECTORY ${PROJECT_SOURCE_DIR_NS3}/build)
...
set(THIRD_PARTY_DIRECTORY ${PROJECT_SOURCE_DIR_NS3}/3rd-party)
...
macro(fetch_git_submodule submodule_path)
    if(NOT EXISTS "${PROJECT_SOURCE_DIR_NS3}/${submodule_path}/.git")
        execute_process(COMMAND ${GIT_EXECUTABLE} submodule --init ${PROJECT_SOURCE_DIR_NS3}/${submodule_path}
...
macro(process_options)
    ...
    file(GLOB_RECURSE include_files ${PROJECT_SOURCE_DIR_NS3}/src/*.h) #just copying every single header into ns3 include folder
    ...
    if(${NS3_CLICK})
        if(WIN32 OR APPLE)
            ...
            configure_file(${PROJECT_SOURCE_DIR_NS3}/3rd-party/ClickCMakeLists.txt ${PROJECT_SOURCE_DIR_NS3}/3rd-party/click/CMakeLists.txt COPYONLY)
    ...
    if(${NS3_OPENFLOW})
        ...
        include_directories(${PROJECT_SOURCE_DIR_NS3}/3rd-party/openflow/include)
        #if (WIN32)
    ...
    list(APPEND CMAKE_MODULE_PATH "${PROJECT_SOURCE_DIR_NS3}/buildsupport/custom_modules")

    set(NOT_FOUND_MSG  "is required and couldn't be found")

    #Libpcre2 for regex
#    include(${PROJECT_SOURCE_DIR_NS3}/buildsupport/custom_modules/FindPCRE.cmake)
#    find_package(PCRE)
#    if (NOT ${AUTOINSTALL_DEPENDENCIES})
...
macro (build_lib libname source_files header_files libraries_to_link test_sources)
    ...
    if(${NS3_PYTHON} AND EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/bindings")
        ...
        set(modulegen_modular_command  python2 ${CMAKE_SOURCE_DIR_NS3}/bindings/python/ns3modulegen-modular.py ${CMAKE_CURRENT_SOURCE_DIR} ${arch} ${libname_sub} ${CMAKE_CURRENT_SOURCE_DIR}/bindings/${module_src})
